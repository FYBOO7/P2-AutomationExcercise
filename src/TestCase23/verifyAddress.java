...
public class verifyAddress {
	...
	public void checkout() {
        ...
        String checkoutaddress=driver.findElement(By.xpath("//ul[@id=\"address_delivery\"]//li[4]")).getText();
        
        String expectedAddress= "Solapur";
		Assert.assertEquals(checkoutaddress, expectedAddress, "Page title doesn't match the expected title");
